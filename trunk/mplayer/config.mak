...
CFLAGS   = -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls -Wstrict-prototypes -Wmissing-prototypes -Wdisabled-optimization -Wno-pointer-sign -Wdeclaration-after-statement -std=gnu99  -O3 -mcpu=750 -meabi -mrvl -msdata -mpaired -mmultiple -mstring -mrecip -pipe -g -ffast-math -DGEKKO -DHW_RVL -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -Ilibdvdread4 -I$(DEVKITPRO)/portlibs/ppc/include -I$(DEVKITPRO)/libogc/include -I. -Iffmpeg  -DFF_API_MAX_STREAMS=0
CXXFLAGS = -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls  -O3 -mcpu=750 -meabi -mrvl -msdata -mpaired -mmultiple -mstring -mrecip -pipe -g -ffast-math -DGEKKO -DHW_RVL -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS -Ilibdvdread4 -I$(DEVKITPRO)/portlibs/ppc/include -I$(DEVKITPRO)/libogc/include -I. -Iffmpeg  -DFF_API_MAX_STREAMS=0
CC_DEPFLAGS = -MD -MP -O3 -mcpu=750 -meabi -mrvl -msdata -mpaired -mmultiple -mstring -mrecip -pipe -g -ffast-math
...
ASFLAGS    = $(CFLAGS)
AS_DEPFLAGS= -MD -MP -O3 -mcpu=750 -meabi -mrvl -msdata -mpaired -mmultiple -mstring -mrecip -pipe -g -ffast-math
HOSTCC     = $(HOST_CC)
